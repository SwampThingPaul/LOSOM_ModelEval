...
```{r}
colmat1=ifelse(per.diff[,c(3,4,6:20)]<0,rgb(198/255,239/255,206/255,0.75),ifelse(per.diff[,c(3,4,6:20)]>0,rgb(255/255,199/255,206/255,0.75),NA))
colmat2=ifelse(per.diff[,5]<0,rgb(255/255,199/255,206/255,0.75),ifelse(per.diff[,5]>0,rgb(198/255,239/255,206/255,0.75),NA))
