...
**DRAFT** - `r paste(format(as.Date("2021-10-11"),"%B %d, %Y"))#,"<br>(Updated:", format(as.Date(Sys.Date()),"%B %d, %Y"),")")`
...
* **Water supply & flood control constraints put pressure on the estuaries as the primary outlet for CS&F Project**

* **Alternative CC redistributes harmful regulatory flows from the SLE to CE**

* **Flows to CE are measured at S-77 when conditions are wet** – .small[does not take into account watershed runoff when making release decisions (flows always measured at S-80 in SLE)]
...
knitr::include_graphics('./Plots/process/AltCC_withnotes.png')
```
...
knitr::include_graphics('./Plots/process/AltCC_flow_withnotes.png')
```
...
*Some of these concepts in-part have been included the current Iteration 3 - Phase 1 sensitivity runs*

---
name: LOSOMProcess

### Next Steps in the LOSOM Process
...
knitr::include_graphics('./Plots/process/Iter3_Phases.png')
```

.small[
*From USACE Technical Stakeholder Engagement - 16-17 Sept 2021 meeting presentation*
]
...
## Iteration 3 Modeling<br>Data Analysis
...
knitr::include_graphics('./Plots/Iteration3_TechEval/CRE_RECOVER_SalEnv_LOKBasin.png')
```
]
...
knitr::include_graphics('./Plots/Iteration3_TechEval/CRE_RECOVER_SalEnv_LOKBasin_FWO.png')
```
]
...
knitr::include_graphics('./Plots/Iteration3_TechEval/SLE_RECOVER_SalEnv_LOKBasin.png')
```
]
...
knitr::include_graphics('./Plots/Iteration3_TechEval/SLE_RECOVER_SalEnv_LOKBasin_FWO.png')
```
]
